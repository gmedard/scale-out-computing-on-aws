...
cd /root/playbooks
ansible-playbook proxy.yml -e Region={{Region}} -e Domain={{Domain}} -e S3InstallBucket={{S3InstallBucket}} -e S3InstallFolder={{S3InstallFolder}} -e ClusterId={{ClusterId}} &> /root/ansible.log
